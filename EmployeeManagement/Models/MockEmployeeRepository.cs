...
namespace EmployeeManagement.Models
{
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        Employee IEmployeeRepository.UpdateEmployee(Employee employeeChange)
        {
            Employee employee = _employeeList.FirstOrDefault(emp => emp.Id == employeeChange.Id);
            if (employee != null)
            {
        ...
        Employee IEmployeeRepository.DeleteEmployee(int employeeId)
        {

            Employee employee = _employeeList.FirstOrDefault(emp => emp.Id == employeeId);
            if (employee != null)
            {
